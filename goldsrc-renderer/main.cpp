...
#include <stdlib.h>         // abort, malloc, free, exit
...
static void SetupVulkanWindow(ImGui_ImplVulkanH_Window* wd, VkSurfaceKHR m_Surface, int width, int height)
{
...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(m_Window))
    {
        ...
        // 2. Show a simple m_Window that we create ourselves. We use a Begin/End pair to created a named m_Window.
        {
            static float f = 0.0f;
        ...
        {
            ImGui::Begin("Another Window", &show_another_window);   // Pass a pointer to our bool variable (the m_Window will have a closing button that will clear the bool when clicked)
