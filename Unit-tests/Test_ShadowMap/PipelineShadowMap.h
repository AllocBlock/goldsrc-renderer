...
protected:
    virtual std::filesystem::path _getVertShaderPathV() override { return "shader/vertShadowMap.spv"; }
    virtual std::filesystem::path _getFragShaderPathV() override { return "shader/fragShadowMap.spv"; }
