...
class CRenderPassBlendMerge : public CRenderPassFullScreenGeneral
{
protected:
    virtual ptr<IPipeline> _initPipelineV() override
    {
         auto pPipeline = make<CPipelineBlendMerge>();
         pPipeline->setInputPort(m_pPortSet->getInputPort("Input"), m_pPortSet->getInputPort("Blur"));
         return pPipeline;
    }
    ...
    virtual void _initPortDescV(SPortDescriptor& vioDesc) override
    {
        ...
        Ports.addInput("Blur", SPortFormat::createAnyOfUsage(EUsage::READ));
