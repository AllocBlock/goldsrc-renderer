...
sptr<CIOImage> createSingleValueImage(size_t vWidth, size_t vHeight, uint8_t vValue)
{
...
int main()
{
    ...
    sptr<CIOImage> TestImage1 = createSingleValueImage(4, 4, 1);

    // test image 2, size 2x2, full of 2
    sptr<CIOImage> TestImage2 = createSingleValueImage(2, 2, 2);

    // test image 3, size 4x4, full of 3
    sptr<CIOImage> TestImage3 = createSingleValueImage(4, 4, 3);
    ...
    // print result
    sptr<CIOImage> pCombinedImage = Lightmap.getCombinedLightmap();
