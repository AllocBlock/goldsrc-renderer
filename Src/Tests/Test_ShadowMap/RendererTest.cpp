...
{
    m_pLightDepthImage = vk::createDepthImage(**m_AppInfo.pDevice, m_AppInfo.Extent);
    m_pShadowMapDepthImage = vk::createDepthImage(**m_AppInfo.pDevice, m_AppInfo.Extent, VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT);
}
