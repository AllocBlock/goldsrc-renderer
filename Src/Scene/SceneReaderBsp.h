...
private:
    ...
    void __readTextures();
    std::vector<ptr<CMeshDataGoldSrc>> __loadLeaf(size_t vLeafIndex);
    std::vector<ptr<CMeshDataGoldSrc>> __loadEntity(size_t vModelIndex);
    void __loadBspTree();
    void __loadBspPvs();
    ...
    void __appendCube(glm::vec3 vOrigin, float vSize, ptr<CMeshDataGoldSrc> voObject);
    ...
    void __appendBspFaceToObject(ptr<CMeshDataGoldSrc> pObject, uint32_t vFaceIndex);
